...
#include "MoonshotBaseGameState.h"
#include "EngineUtils.h"
#include "GameFramework/PlayerStart.h"
#include "Engine/PlayerStartPIE.h"

AMoonshotBaseGameMode::AMoonshotBaseGameMode(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
	GameStateClass = AMoonshotBaseGameState::StaticClass();
}
/*
AActor* AMoonshotBaseGameMode::ChoosePlayerStart_Implementation(AController* Player)
{
...
bool AMoonshotBaseGameMode::CanPlayerPawnFit(const APlayerStart* SpawnPoint, const AController* Player) const
{
